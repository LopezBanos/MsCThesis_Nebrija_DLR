...
\begin{tabular}{ c | c | c | c | c }
  ...
  \hline  
\end{tabular}
\caption{Different items -- decimal numbers -- described by its binary expansion.}
\end{table}
