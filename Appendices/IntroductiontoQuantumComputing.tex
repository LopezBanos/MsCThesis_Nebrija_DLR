...
\begin{definition}[Unitary Operator]
    ...
    \begin{equation}
        \braket{U\psi|U\varhi} = \braket{\psi|\varphi} \; \forall \ket{\psi},\ket{\varphi} \in \mathbb{H}
    \end{equation}
\end{definition}
One of the paradigm of universal quantum computing is the gate model. This approach substitute classical logic gates such as AND, OR , XOR, NOT ... by its quantum equivalent. This quantum gates are represented by unitary matrices, in this way the inner product is preserved.\\\\
Equivalently, a quantum gate is 
