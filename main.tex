...
\large \textit{A thesis submitted in fulfilment of the requirements \\ for the degree of \degreename \\ at Nebrija University.}\\[0.3cm] % University requirement text
...
\dedicatory{Dedico esta Tesis de Máster a mis padres, cuyo esfuerzo ha permitido que estudiase en la universidad y cuyo ejemplo me ha guiado, inspirado y motivado en el camino.} 
...
\include{Appendices/A_IntroductiontoQuantumComputing.tex}
\include{Appendices/B_SimulatedAnneling.tex}
\include{Appendices/C_Hardware.tex}
\include{Appendices/D_PythonScripts.tex}
