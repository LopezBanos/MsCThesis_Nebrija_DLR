...
\begin{mini!}[2]
	{\mathbf{x}}{f(\mathbf{x}, \mathbf{y})}{\label{eq: MILP}}{}{\left[f: \mathbb{R}^{n}\times \mathbb{Z}^{m} \rightarrow \mathbb{R}\right]}
...
\begin{mini!}[2]
	{x}{\alpha \equiv mx}{}{}{}
	\addConstraint{h(x)= ax - by^{*} }{=0}{\quad :\lambda}{}
...
\begin{mini!}[2]
	...
	\addConstraint{\alpha}{\geq \alpha_{\text{down}}}{}
    \addConstraint{\alpha}{\geq \underbrace{\lambda \left(- by\right)}_{\text{Benders' cuts}}}{}
    \addConstraint{0 \leq y}{\leq 1.}{}
\end{mini!}
\end{tcolorbox}
...
\begin{maxi!}[2]
	...
	\addConstraint{\mu}{\geq \mathbf{0}}{}
	\addConstraint{(\lambda, \mu)}{}{\in \{\lambda, \mu \,\mid q(\lambda, \mu)\quad \text{Bounded} \}}.
\end{maxi!}
